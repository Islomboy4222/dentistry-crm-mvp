...
@push('scripts')
  <script>
      $('.tooth-11').mouseover(function(){
        ...
        //Click methods
        $('.tooth-11').click(function(e) {
            setNumberTooth(this);
        })
        //Search tooth number and set to input
        function setNumberTooth(element) {
            var numbstr = $(element).attr('class');
            //RegExp
            var r = /\d+/;
            var number = numbstr.match(r);  
            $('input[name=tooth_position]').val(number);
        }

        $('.tooth-12').click(function(e) {
            setNumberTooth(this);
        })
        //Search tooth number and set to input
        function setNumberTooth(element) {
